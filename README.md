...
- **[carecover](https://github.com/dommango/carecover)** — a small app to
  ...
  gaps get escalated. *(Next.js · Prisma · Twilio — learning as I go)*
- **[modular-mind](https://github.com/dommango/modular-mind)** — me trying to
  teach AI to design modular-synth patches by learning from a pile of VCV Rack
  files. Half code project, half excuse to mess with synths. *(Python)*
